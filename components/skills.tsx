...
export default function SkillsSection({ categories }: SkillsProps) {
  return (
    <section
      id='skills'
      className='w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b from-secondary/15 to-background relative'
    >
        ...
        <div className='flex-col items-center justify-center space-y-4'>
          <div className='space-y-2'>
            <SectionHeading className='md:pl-16 overflow-hidden tracking-tighter text-start w-full'>
              <SlideIn className='text-accent-foreground/50'>Skills &</SlideIn>
              <br />
              <SlideIn>
            ...
            <div className='text-center max-w-[1200px] text-2xl/relaxed text-muted-foreground md:pl-16 pb-12'>
              <MotionAnimatedText>
                Tecnologias e ferramentas que utilizo para criar soluções web de alta qualidade.
              </MotionAnimatedText>
            </div>
          </div>
        </div>
